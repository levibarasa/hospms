...
public class viewDoctor extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        String sql = "select count,date,name,age,gender,blood,dept,phone,email,status,address,room,username from doctor";
        try {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Doctor Report");
        ...
        rPassBtn.setBackground(new java.awt.Color(255, 51, 51));
