...
public class viewReceptionist extends javax.swing.JFrame {
    ...
    public viewReceptionist() {
        ...
        Object columns[] = {"ID", "Joining Date", "Name", "Age", "Gender", "Blood Group", "Email Address", "Phone Number", "Address", "Status", "Username", "Password"};
    ...
    public final void loadData() {
        ...
        String sql = "select count,joining,name,age,gender,blood,email,phone,address,status,username from receptionist";
        try {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Receptionist Report");
