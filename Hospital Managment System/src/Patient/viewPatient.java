...
public class viewPatient extends javax.swing.JFrame {
    ...
    public viewPatient() {
        ...
        Object columns[] = {"ID", "Date", "Name", "Age", "Gender", "Address", "Phone Number", "Status", "Disease", "Room Number"};
    ...
    public void loadData() {
        ...
        String sql = "select count,date,name,age,gender,address,phone,status,disease,room from patient";
        try {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Patients Report");
